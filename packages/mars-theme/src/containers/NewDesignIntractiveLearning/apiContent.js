  ...
  return (
    <div className="container api-section">
      ...
      {apidata && apidata.length > 0 ? (
        apidata?.map((postitem, key) => {
          const keyitem = key % 2 == 0;
          const featuremedia =
        ...
        <>
          <div className="api-content flex-normal">
            <div className="api-content-detail mr-90">
              <h3>
                Use CurrikiStudio to build and publish interactive courses
              </h3>
              <p>
          ...
          <div className="api-content flex-reverse">
            ...
            <div className="api-content-detail ml-75">
              ...
              <p>
                With our API, our goal is that organizations leverage our
                technology to save time and resources to author interactive
                courses. Our API is built as components so you can use pieces
                for creating interactive lessons, publishing to various
                destinations, and storing in a dynamic, searchable library (or
                LOR).
              </p>
              <a href="wwww.curriki.org" target="_blank">
                See documentation
          ...
          <div className="api-content flex-reverse">
            ...
            <div className="api-content-detail ml-75">
              <h3>
                Contribute new learning activities to the Curriki ecosystem
              </h3>
              <p>
                We are actively looking for how to integrate new tools and
                functionality into our open source offering. If you have an
                educational solution - from a full package to a snippet of code
                - that you think would go well in Curriki, please let us know.
              </p>
              <a href="wwww.curriki.org" target="_blank">
                See documentation
              </a>
